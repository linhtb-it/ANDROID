...
public class HotVideo_Controller extends RecyclerView.Adapter<HotVideo_Controller.ViewHolder>{
    Context context;
    ArrayList<Video> videosList;
    public HotVideo_Controller(Context context, ArrayList<Video> videosList) {
    ...
    @NonNull
    @Override
    public HotVideo_Controller.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HotVideo_Controller.ViewHolder holder, int position) {
        ...
        holder.tv_TimeCreate.setText("Ngày phát hành: " + videosList.get(position).getDate_Created());
